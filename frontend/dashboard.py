        ...
        ui.layout(
            ...
            zones=[
                ...
                ui.zone('middle', direction=ui.ZoneDirection.ROW, size='780px',
                        zones=[ui.zone('middle_left',direction=ui.ZoneDirection.COLUMN, size = '25',
                                       zones=[ui.zone('ltop', size='50%'),
                                              ui.zone('lbottom', size='50%')]),
                               ui.zone('middle_right', size='75%',justify='between',direction=ui.ZoneDirection.COLUMN, align = 'stretch',
                                       zones=[ui.zone('rtop', size = '10%'),
                                              ui.zone('rmid', size = '40%', direction = ui.ZoneDirection.ROW, align = 'start'),
